...
# delete_all_users() ELIMINA TODOS LOS ID
...
# Agregar el middleware de CORS antes que otros middlewares
origins = [
    "https://localhost",
    "http://localhost",
    "http://localhost:8000",
...
app.add_middleware(MyMiddleware)  # Añadir el middleware de tiempo de procesamiento una vez que se ha agregado el middleware de CORS
